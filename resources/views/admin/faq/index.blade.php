                        ...
                        <thead>
                           ...
                           <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$faq->solution}}</td>
                                <td>
                                    <a href="{{route('admin.faq.edit', $faq->id)}}" class="blue-text mr-3" data-toggle="tooltip" title="Edit" data-placement="left"><i class="fa fa-pencil"></i></a>
                                    <a href="javascript:void(0);" data-href="{{ route('admin.faq.destroy', $faq->id) }}" class="anchor_delete text-danger" data-method="delete" data-action="faq" data-from="faq" data-toggle="tooltip" title="Delete" data-placement="right"><i class="fa fa-trash"></i></a> 
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
